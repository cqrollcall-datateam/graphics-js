...
var renderBarChart = function (config) {
  ...
  var xAxis = d3
    ...
    .tickFormat(function (d) {
      return d.toFixed(1); //change % for unit of your choice
    });
  ...
  chartElement
    ...
    .text(function (d, i) {
      if (i == 0) { 
        return d[valueColumn].toFixed(1) + " overdose deaths per 100K" //use this line to create labels on the first unit
      } else {
