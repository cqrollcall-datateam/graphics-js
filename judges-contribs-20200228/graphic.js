...
var renderStackedBarChart = function(config) {
  ...
  var colorScale = d3
    ...
    .range([COLORS.rchighlight3, COLORS.gray2]);
  ...
  var xAxis = d3
    ...
    .tickFormat(function (d, i) {
      if (d == 600) {
        return "$" + d.toFixed(0) + "K" //use this line to create labels on the first unit
      } else {
        return d.toFixed(0) //use the .toFixed() function to specify decimals
      }
    })
